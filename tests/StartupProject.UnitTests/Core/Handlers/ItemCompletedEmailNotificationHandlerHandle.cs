...
using StartupProject.Core.Events;
using StartupProject.Core.Interfaces;
using StartupProject.Core.Services;
using Moq;
using System;
...
namespace StartupProject.UnitTests.Core.Entities
{
